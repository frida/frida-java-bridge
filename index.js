...
/* global console, Memory, Module, Int64, NativePointer, Process, NativeCallback, NativeFunction, ptr, WeakRef, NULL */
...
function ClassFactory (api, vm) {
  ...
  this.choose = function (className, callbacks) {
    ...
    if (api.addLocalReference === null) {
      ...
      let pattern;
      if (runtime.androidVersion.indexOf('4.2.') === 0) {
        // verified with 4.2.2
    ...
    function makeMethod (methodName, type, methodId, retType, argTypes, env) {
      ...
      function replaceArtImplementation (fn) {
        ...
        if (fn !== null) {
          ...
          if (artQuickGenericJniTrampoline === null && runtime.androidVersion.indexOf('6.0.') === 0) {
