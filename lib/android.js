...
class ArtQuickCodeInterceptor {
  ...
  _createTrampoline () {
    ...
    if (pointerSize === 4 || this._canRelocateCode(maxRedirectSize)) {
      ...
      trampoline = trampolineAllocator.allocateSliceNear(this.quickCodeAddress, maxDistance);
    }
