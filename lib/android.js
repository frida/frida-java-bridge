...
function _getApi () {
  ...
  if (isArt) {
    ...
    temporaryApi.artHeap = Memory.readPointer(artRuntime.add(runtimeOffset.heap));
    temporaryApi.artThreadList = Memory.readPointer(artRuntime.add(runtimeOffset.threadList));
     ...
     */
    const classLinker = Memory.readPointer(artRuntime.add(runtimeOffset.classLinker));
