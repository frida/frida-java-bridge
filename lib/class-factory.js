...
const {getAndroidVersion, getRuntimeSpec, getClassLinkerSpec, getArtMethodSpec} = require('./android');
    ...
    function makeMethod (methodName, type, methodId, retType, argTypes, env) {
      ...
      function replaceArtImplementation (fn) {
        ...
        if (fn !== null) {
          ...
          const runtimeSpec = getRuntimeSpec(vm, factory);
          const classLinkerSpec = getClassLinkerSpec(vm, factory);
          let errorMessage;
          ...
          if (artQuickGenericJniTrampoline === null && getAndroidVersion(factory).indexOf('6.0') === 0) {
            artQuickGenericJniTrampoline = api.artQuickGenericJniTrampoline;
          }
