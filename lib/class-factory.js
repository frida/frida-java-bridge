      ...
      if (spec.superClass) {
        Object.defineProperty(Klass.$classWrapper.prototype, '$super', {
          ...
          value: function (name, ...args) {
            const methods = Klass.$classWrapper.__super__[name];
            if (!methods || !methods.overloads) {
              throw new Error(name + ': cannot find matching method');
            }
            const overloads = methods.overloads;
