  ...
  invoke: {
    value (receiver, args) {
      ...
      if (methodsThatCanBeInvoked.length === 0) {
        ...
        console.warn("Multiple overloads fit the invocation of " + receiver + 
        ",\n The overload that will be used is: " + methodsThatCanBeInvoked[0] +
        ",\n To avoid this warining please choose one of the follwoing overloads and invoke it specifically: " + methodsThatCanBeInvoked);
      }
