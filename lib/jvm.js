...
const jvmtiCapabilities = {
  ...
  'can_force_early_return': 200000000,
  ...
  'can_generate_early_vmstart': 20000000000,
  'can_generate_early_class_hook_events': 40000000000,
  'can_generate_sampled_object_alloc_events': 80000000000
};
...
function getEnvJvmti (api) {
  ...
  vm.perform(() => {
    ...
    capaBuf.writeU64(jvmtiCapabilities.can_tag_objects);
